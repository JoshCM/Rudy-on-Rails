...
public class Rail extends InteractiveGameObject implements PlaceableOnSquare, Comparable<Rail> {
	...
	/**
	 * Pr�ft, ob die Rail eine Gerade ist
	 * @return Gibt true zur�ck, wenn die Rail eine Gerade ist
	 */
	...
	/**
	 * Gibt die Richtung der Rail zur�ck: Dabei ist die Richtung 
	 * - North, wenn die Rail nur eine Gerade besitzt, welche von Norden nach S�den oder S�den nach Norden geht
