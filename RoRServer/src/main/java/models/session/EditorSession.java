...
public class EditorSession extends RoRSession {
	...
	private void createHostPlayer(UUID playerId, String playerName) {
		EditorPlayer player = new EditorPlayer(getDescription(), playerName, playerId, true);
		addPlayer(player);
	}
	
	public Player createPlayer(UUID playerId, String playerName) {
		EditorPlayer player = new EditorPlayer(getDescription(), playerName, playerId, false);
		addPlayer(player);
		return player;
	}
