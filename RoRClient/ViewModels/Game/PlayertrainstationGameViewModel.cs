...
{
    class PlayertrainstationGameViewModel : TrainstationGameViewModel
    {
        Playertrainstation trainstation;

        public PlayertrainstationGameViewModel(Playertrainstation trainstation) : base(trainstation)
        {
